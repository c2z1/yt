 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "yourtasks.de", ownerName = "yourtasks.de", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBwY-J2WjUpsXfJbCyGfUT5Kw5F1AjbfDI";
