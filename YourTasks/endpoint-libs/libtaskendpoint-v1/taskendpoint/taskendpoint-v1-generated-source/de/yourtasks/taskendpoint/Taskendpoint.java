 ...
 * on 2014-08-05 at 06:33:25 UTC 
 * Modify at your own risk.
 */

package de.yourtasks.taskendpoint;
...
public class Taskendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the taskendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  /**
   * Create a request for the method "convertModel".
   *
   * This request holds the parameters needed by the taskendpoint server.  After setting any optional
   * parameters, call the {@link ConvertModel#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
  public ConvertModel convertModel(java.lang.Long id) throws java.io.IOException {
    ConvertModel result = new ConvertModel(id);
    initialize(result);
    return result;
  }

  public class ConvertModel extends TaskendpointRequest<Void> {

    private static final String REST_PATH = "convertModel/{id}";

    /**
     * Create a request for the method "convertModel".
     *
     * This request holds the parameters needed by the the taskendpoint server.  After setting any
     * optional parameters, call the {@link ConvertModel#execute()} method to invoke the remote
     * operation. <p> {@link
     * ConvertModel#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param id
     * @since 1.13
     */
    protected ConvertModel(java.lang.Long id) {
      super(Taskendpoint.this, "POST", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }

    @Override
    public ConvertModel setAlt(java.lang.String alt) {
      return (ConvertModel) super.setAlt(alt);
    }

    @Override
    public ConvertModel setFields(java.lang.String fields) {
      return (ConvertModel) super.setFields(fields);
    }

    @Override
    public ConvertModel setKey(java.lang.String key) {
      return (ConvertModel) super.setKey(key);
    }

    @Override
    public ConvertModel setOauthToken(java.lang.String oauthToken) {
      return (ConvertModel) super.setOauthToken(oauthToken);
    }

    @Override
    public ConvertModel setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ConvertModel) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ConvertModel setQuotaUser(java.lang.String quotaUser) {
      return (ConvertModel) super.setQuotaUser(quotaUser);
    }

    @Override
    public ConvertModel setUserIp(java.lang.String userIp) {
      return (ConvertModel) super.setUserIp(userIp);
    }
    ...
    public ConvertModel setId(java.lang.Long id) {
      this.id = id;
      return this;
    }

    @Override
    public ConvertModel set(String parameterName, Object value) {
      return (ConvertModel) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "convertProjects".
   *
   * This request holds the parameters needed by the taskendpoint server.  After setting any optional
   * parameters, call the {@link ConvertProjects#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
  public ConvertProjects convertProjects(java.lang.Long id) throws java.io.IOException {
    ConvertProjects result = new ConvertProjects(id);
    initialize(result);
    return result;
  }

  public class ConvertProjects extends TaskendpointRequest<Void> {

    private static final String REST_PATH = "convertProjects/{id}";

    /**
     * Create a request for the method "convertProjects".
     *
     * This request holds the parameters needed by the the taskendpoint server.  After setting any
     * optional parameters, call the {@link ConvertProjects#execute()} method to invoke the remote
     * operation. <p> {@link ConvertProjects#initialize(com.google.api.client.googleapis.services.Abst
     ...
     * @since 1.13
     */
    protected ConvertProjects(java.lang.Long id) {
      super(Taskendpoint.this, "POST", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }

    @Override
    public ConvertProjects setAlt(java.lang.String alt) {
      return (ConvertProjects) super.setAlt(alt);
    }

    @Override
    public ConvertProjects setFields(java.lang.String fields) {
      return (ConvertProjects) super.setFields(fields);
    }

    @Override
    public ConvertProjects setKey(java.lang.String key) {
      return (ConvertProjects) super.setKey(key);
    }

    @Override
    public ConvertProjects setOauthToken(java.lang.String oauthToken) {
      return (ConvertProjects) super.setOauthToken(oauthToken);
    }

    @Override
    public ConvertProjects setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ConvertProjects) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ConvertProjects setQuotaUser(java.lang.String quotaUser) {
      return (ConvertProjects) super.setQuotaUser(quotaUser);
    }

    @Override
    public ConvertProjects setUserIp(java.lang.String userIp) {
      return (ConvertProjects) super.setUserIp(userIp);
    }
    ...
    public ConvertProjects setId(java.lang.Long id) {
      this.id = id;
      return this;
    }

    @Override
    public ConvertProjects set(String parameterName, Object value) {
      return (ConvertProjects) super.set(parameterName, value);
    }
  }
  ...
  public class GetTask extends TaskendpointRequest<de.yourtasks.taskendpoint.model.Task> {
    ...
    protected GetTask(java.lang.Long id) {
      super(Taskendpoint.this, "GET", REST_PATH, null, de.yourtasks.taskendpoint.model.Task.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   *
   * @param content the {@link de.yourtasks.taskendpoint.model.Task}
   * @return the request
   */
  public InsertTask insertTask(de.yourtasks.taskendpoint.model.Task content) throws java.io.IOException {
    InsertTask result = new InsertTask(content);
    initialize(result);
    return result;
  }

  public class InsertTask extends TaskendpointRequest<de.yourtasks.taskendpoint.model.Task> {
     ...
     * @since 1.13
     */
    protected InsertTask(de.yourtasks.taskendpoint.model.Task content) {
      super(Taskendpoint.this, "POST", REST_PATH, content, de.yourtasks.taskendpoint.model.Task.class);
    }
   ...
   *
   * This request holds the parameters needed by the taskendpoint server.  After setting any optional
   * parameters, call the {@link ListTask#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  ...
  public class ListTask extends TaskendpointRequest<de.yourtasks.taskendpoint.model.CollectionResponseTask> {
     ...
     */
    protected ListTask() {
      super(Taskendpoint.this, "GET", REST_PATH, null, de.yourtasks.taskendpoint.model.CollectionResponseTask.class);
    }
    ...
    public ListTask setProjectId(java.lang.Long projectId) {
    ...
    @com.google.api.client.util.Key
    private java.lang.Boolean withCompleted;

    /**

     */
    public java.lang.Boolean getWithCompleted() {
      return withCompleted;
    }

    public ListTask setWithCompleted(java.lang.Boolean withCompleted) {
   ...
   *
   * This request holds the parameters needed by the taskendpoint server.  After setting any optional
   * parameters, call the {@link RemoveTask#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
   ...
   * @return the request
   */
  public UpdateTask updateTask(de.yourtasks.taskendpoint.model.Task content) throws java.io.IOException {
    UpdateTask result = new UpdateTask(content);
    initialize(result);
    return result;
  }

  public class UpdateTask extends TaskendpointRequest<de.yourtasks.taskendpoint.model.Task> {
     ...
     * @since 1.13
     */
    protected UpdateTask(de.yourtasks.taskendpoint.model.Task content) {
      super(Taskendpoint.this, "PUT", REST_PATH, content, de.yourtasks.taskendpoint.model.Task.class);
    }
